...
class module(baseModule):
    ...
    def registerToBroker(self): return _inaoqi.module_registerToBroker(self)
...
class behavior(baseModule):
    ...
    def session(self): return _inaoqi.behavior_session(self)
    def acquireResources(self): return _inaoqi.behavior_acquireResources(self)
    ...
    def registerToBroker(self): return _inaoqi.behavior_registerToBroker(self)
    ...
    def setParentFromName(self, *args): return _inaoqi.behavior_setParentFromName(self, *args)
    ...
    def connectInput(self, *args): return _inaoqi.behavior_connectInput(self, *args)
    def connectParameter(self, *args): return _inaoqi.behavior_connectParameter(self, *args)
    def connectOutput(self, *args): return _inaoqi.behavior_connectOutput(self, *args)
    def _reportError(self, *args): return _inaoqi.behavior__reportError(self, *args)
